...
Gebt dafür in das Fenster URL einfach `https://github.com/sannennetarou/DufteRanatomie` ein. Das Deck wird hierbei umbenannt, der Fortschritt und Note Type bleiben beibehalten.
